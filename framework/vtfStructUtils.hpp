...
APPLY(DEF, VkPhysicalDeviceDescriptorHeapFeaturesEXT, VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_HEAP_FEATURES_EXT) \
...
MKSTYPE(VkPhysicalDeviceDescriptorHeapPropertiesEXT, VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_HEAP_PROPERTIES_EXT);
MKSTYPE(VkResourceDescriptorInfoEXT,				VK_STRUCTURE_TYPE_RESOURCE_DESCRIPTOR_INFO_EXT);
MKSTYPE(VkBindHeapInfoEXT,							VK_STRUCTURE_TYPE_BIND_HEAP_INFO_EXT);
MKSTYPE(VkPushDataInfoEXT,							VK_STRUCTURE_TYPE_PUSH_DATA_INFO_EXT);
MKSTYPE(VkShaderDescriptorSetAndBindingMappingInfoEXT, VK_STRUCTURE_TYPE_SHADER_DESCRIPTOR_SET_AND_BINDING_MAPPING_INFO_EXT);
MKSTYPE(VkDescriptorSetAndBindingMappingEXT,		VK_STRUCTURE_TYPE_DESCRIPTOR_SET_AND_BINDING_MAPPING_EXT);
MKSTYPE(VkPipelineCreateFlags2CreateInfo,			VK_STRUCTURE_TYPE_PIPELINE_CREATE_FLAGS_2_CREATE_INFO);
